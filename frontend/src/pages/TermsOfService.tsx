        ...
        <div className="max-w-4xl mx-auto space-y-8 animate-fade-in">
          <Card className="p-8 backdrop-blur-sm bg-white/50">
            ...
            <div className="space-y-6 text-gray-700">
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-3">1. サービスの概要</h2>
                <p>
              ...
              <section>
                ...
                <ol className="list-decimal list-inside space-y-2">
                  <li>ユーザーは、自己の責任において当サービスを利用するものとします。</li>
                  <li>ユーザーは、当サービスの利用にあたり、法令、本規約および公序良俗に反する行為を行わないものとします。</li>
                  <li>当サービスの利用は無料ですが、将来的に有料機能が追加される可能性があります。</li>
                </ol>
              </section>
              ...
              <section>
                ...
                <ol className="list-decimal list-inside space-y-2">
                  <li>当サービスで提供される情報は、投資判断の参考情報であり、投資の成功を保証するものではありません。</li>
                  <li>実際の投資判断はユーザー自身の責任において行ってください。</li>
                  <li>当サービスの利用によって生じたいかなる損害についても、運営者は責任を負いません。</li>
                  <li>当サービスは、予告なくメンテナンスや機能更新を行うことがあります。</li>
                </ol>
              </section>
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-3">5. サービスの変更・中断・終了</h2>
                <p>
                  運営者は、以下の場合に、予告なく当サービスの全部または一部の提供を変更、中断、または終了することがあります：
                </p>
                <ul className="list-disc list-inside space-y-2 mt-2">
                  <li>システムの保守点検または更新を行う場合</li>
                  <li>火災、停電、天災などの不可抗力により、サービスの提供が困難になった場合</li>
              ...
              <section>
                <h2 className="text-2xl font-semibold mb-3">7. 準拠法と管轄裁判所</h2>
                <p>
